...
"https://telegra.ph/file/7697fe40c5134598850d4.jpg"]
 ...
 let fkon = { key: { fromMe: false, participant: `${m.sender.split`@`[0]}@s.whatsapp.net`, ...(m.chat ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { contactMessage: { displayName: `${name}`, vcard: `BEGIN:VCARD\nVERSION:3.0\nN:;a,;;;\nFN:${name}\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`}}}
  ...
  "businessOwnerJid": `${m.sender.split`@`[0]}@s.whatsapp.net`
    ...
    thumbnail: await (await fetch(hwaifu + 'Menu')).buffer(), //Gambarnye
    ...
    thumbnail: await (await fetch(hwaifu + 'Loading')).buffer(), //Gambarnye
...
//-------DOC TEMPLATE
    ...
    //------------------- 2BUTTON VID
    //conn.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7697fe40c5134598850d4.jpg' }, text, footer: '', templateButtons: [{ quickReplyButton: { displayText: 'Menu', id: `${_p}menu` }}, { quickReplyButton: { displayText: 'Owner', id: `${_p}owner bio` }} ] })
