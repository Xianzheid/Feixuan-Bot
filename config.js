...
global.namebot = 'XiaFeixuan-Bot V1'
...
/*============== WATERMARK ==============*/
global.wm = '                「 XiaFeixuan-BOT 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘XiaFeixuan BOT | Xianzhe ID˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ XiaFeixuan-BOT'
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By Xianzhe ID`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '              「 XiaXiaFeixuan-BOT  」'
...
/*============== STICKER WM ==============*/
global.stickpack = 'By'
global.stickauth = `XiaFeixuan-BOT`
