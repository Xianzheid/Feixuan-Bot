...
export async function all(m) {
  let pp = await this.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/5d646d40d6986628ab20a.jpg')
...
mediaType:  1,
mediaUrl: 'https://wa.me/6285326781097',
title: '「 ❔ 」',
body: wm,
sourceUrl: 'http://github.com/xianzheid', thumbnail: await( await fetch(pp)).buffer()
  }
 }}, { quoted: m })
